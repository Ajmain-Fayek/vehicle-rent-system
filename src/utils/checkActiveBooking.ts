 ...
 * @param condition where clause tuple [ "customer_id" | "vehicle_id", 1 ]
 * @example ["vehicle_id", 1] , ["customer_id", 1]
 * @returns boolean
 */
export const checkActiveBooking = async (condition: [field: TdeleteColumn, value: string]): Promise<boolean> => {
  try {
